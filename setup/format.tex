...
\def\centerprisesupervisor#1{\def\@centerprisesupervisor{#1}}\def\@centerprisesupervisor{}
\def\centerprisesupervisortitle#1{\def\@centerprisesupervisortitle{#1}}\def\@centerprisesupervisortitle{}
...
\clearpage{\pagestyle{empty}\cleardoublepage}
   \phantomsection
    ...
    %  \vspace*{1cm}
      ...
      % \@put@covertitle{\@cauthortitle} & \@cauthor \\
      % \@put@covertitle{\@csupervisortitle} & \@csupervisor \\
      % \@put@covertitle{\@centerprisesupervisortitle} & \@centerprisesupervisor \\
      % \end{tabular}
      }}
